...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 02 déc. 2021 à 15:47
...
--
CREATE DATABASE IF NOT EXISTS `entrepriseNEWS` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `entrepriseNEWS`; 
...
CREATE TABLE `employes` (
  ...
  `prenom` varchar(20) DEFAULT NULL COMMENT 'prénom employés',
  `nom` varchar(20) DEFAULT NULL COMMENT 'nom employés',
  `sexe` enum('f','m') NOT NULL COMMENT 'genre employés',
  `service` varchar(30) DEFAULT NULL COMMENT 'service de l''employé',
  `date_embauche` date DEFAULT NULL COMMENT 'date d''embauche',
...
(991, 'Jeanne', 'Bacha', 'f', 'production', '2021-12-02', 2150);
...
--
ALTER TABLE `employes`
  MODIFY `id_employes` int(3) NOT NULL AUTO_INCREMENT COMMENT 'id de la table PK AI', AUTO_INCREMENT=992;
COMMIT;
